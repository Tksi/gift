...
describe('JoinForm', () => {
  ...
  describe('初期状態', () => {
    it('プレイヤー名入力フィールドが表示される', () => {
      const wrapper = mount(JoinForm, { props: defaultProps });
  ...
  describe('送信中状態', () => {
    it('isSubmitting が true の場合、ボタンが無効になる', () => {
    ...
    it('isSubmitting が true の場合、ローディング表示される', () => {
      const wrapper = mount(JoinForm, {
        props: { ...defaultProps, isSubmitting: true },
      });
